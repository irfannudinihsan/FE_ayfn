          ...
          <div
            ...
            {success ? (
              <div
                ...
                <strong>Registration success!</strong>&nbsp;Your account has
                been created. Continue to&nbsp;<Link to={"/login"}>login</Link>
                &nbsp;page
                <button
                  type="button"
                  class="btn-close"
            ...
            <form onSubmit={onSubmitHandler} id="form">
              ...
              <div className="mt-3">
                <button
                  type="submit"
                  className="btn btn-primary bg-gradient btn-block me-1">
                  Register
                </button>
              </div>
              <div className="mt-3">
